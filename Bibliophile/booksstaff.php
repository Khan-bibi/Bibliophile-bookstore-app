...
<body style="background-color:#5a2c0e">
    <div class="container">
        <div class="search-bar">
            ...
            <button id="filter-btn" style="color:#582f06; background-color:#FFEEAD;">Filter</button>
        </div>
        ...
        <div class="book-grid">
            ...
            ?>
                ...
                <div class="book-card">
                    ...
                    <a href="singlebookstaff.php?id=<?= $book['bookID'] ?>" class="book-image">
                    ...
                    <button class="manage-button"
                        onclick="window.location.href='singlebookstaff.php?id=<?= $book['bookID'] ?>';">Manage</button>
